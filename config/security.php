...
return [
    ...
    'password_min_length' => (int) env('SECURITY_PASSWORD_MIN_LENGTH', 3),
    'password_max_length' => (int) env('SECURITY_PASSWORD_MAX_LENGTH', 8),
    'password_require_letter' => env('SECURITY_PASSWORD_REQUIRE_LETTER', true),
    ...
    'password_require_uncompromised' => env('SECURITY_PASSWORD_REQUIRE_UNCOMPROMISED', false),
