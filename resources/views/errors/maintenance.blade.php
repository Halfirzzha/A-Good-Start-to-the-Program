...
<html lang="id">
    <head>
        ...
        <meta name="description" content="Halaman maintenance sedang aktif untuk memastikan stabilitas, performa, dan keamanan sistem.">
    ...
    <body data-theme="light">
        <div class="backdrop" aria-hidden="true">
            ...
            <svg class="cable cable-left" viewBox="0 0 520 240" fill="none" role="presentation" aria-hidden="true">
                <path d="M20 200C120 40 280 40 420 120C470 150 490 170 510 210" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-dasharray="10 12" />
            ...
            <svg class="cable cable-right" viewBox="0 0 520 240" fill="none" role="presentation" aria-hidden="true">
                <path d="M10 30C140 120 300 120 430 40C470 20 490 10 510 10" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-dasharray="10 12" />
        ...
        <main class="page" data-maintenance role="main"
            ...
            <section class="grid">
                <div class="panel tilt-card" data-tilt="0.6">
                    ...
                    <div class="time-grid">
                        ...
                        <div class="time-item" data-time="retry" aria-live="polite" aria-atomic="true" style="{{ is_null($retryAfter) ? 'display:none;' : '' }}">
                ...
                <div class="panel tilt-card" data-tilt="0.5">
                    ...
                    <div class="field">
                        ...
                        <input id="maintenance-token" name="maintenance_token" type="password" placeholder="Masukkan token maintenance" autocomplete="one-time-code">
                    </div>
                    <div class="actions">
